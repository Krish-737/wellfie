/** Date of birth helpers — UI uses DD/MM/YYYY; aligned with BioSense SDK age limits. */
...
/** Max DOB string for date picker boundary (110 years ago). */
