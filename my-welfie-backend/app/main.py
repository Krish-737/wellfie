...
from app.routers import results, auth, payments, reports, oauth,kiosk,diff
...
#kiosk_sessions table is missing in the database, which is causing the error. To fix this, we need to create the kiosk_sessions table in the database. We can do this by adding the following code to our database setup:
